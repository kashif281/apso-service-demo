...
export class GeneratedMigration1762291444861 implements MigrationInterface {
    name = 'GeneratedMigration1762291444861'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "student" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "enrollment_date" date NOT NULL, CONSTRAINT "unique_student_email" UNIQUE ("email"), CONSTRAINT "PK_3d8016e1cb58429474a3c041904" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_a56c051c91dbe1068ad683f536" ON "student" ("email") `);
        await queryRunner.query(`CREATE TABLE "instructor" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "first_name" character varying(255) NOT NULL, "last_name" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "hire_date" date NOT NULL, CONSTRAINT "unique_instructor_email" UNIQUE ("email"), CONSTRAINT "PK_ccc0348eefb581ca002c05ef2f3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_6222960ab4f2b68e84bc00bfee" ON "instructor" ("email") `);
        await queryRunner.query(`CREATE TABLE "enrollment" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "student_id" uuid NOT NULL, "course_id" uuid NOT NULL, "enrollment_date" date NOT NULL, CONSTRAINT "unique_enrollment" UNIQUE ("student_id", "course_id"), CONSTRAINT "PK_7e200c699fa93865cdcdd025885" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_910a2a681d04669f6d7dc4132b" ON "enrollment" ("student_id", "course_id") `);
        await queryRunner.query(`CREATE TABLE "assignment" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying(255) NOT NULL, "description" text, "due_date" date NOT NULL, "status" character varying(255) NOT NULL, CONSTRAINT "PK_43c2f5a3859f54cedafb270f37e" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_046f3219d9796d57ae2af97cbe" ON "assignment" ("title") `);
        await queryRunner.query(`CREATE TABLE "course" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying(255) NOT NULL, "description" text, "start_date" date NOT NULL, "end_date" date NOT NULL, "status" character varying(255) NOT NULL, CONSTRAINT "unique_course_title" UNIQUE ("title"), CONSTRAINT "PK_bf95180dd756fd204fb01ce4916" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_046f3219d9796d57ae2af97cbe"`);
        await queryRunner.query(`DROP TABLE "assignment"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_910a2a681d04669f6d7dc4132b"`);
